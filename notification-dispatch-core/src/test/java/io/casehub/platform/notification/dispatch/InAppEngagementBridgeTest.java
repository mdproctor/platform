...
class InAppEngagementBridgeTest {
    ...
    void setUp() {
        ...
        var recorder = new EngagementRecorder(store, firedEvents::add, enabledProvider);
    ...
    void skipsWhenDisabled() {
        ...
        var disabledRecorder = new EngagementRecorder(store, firedEvents::add, disabledProvider);
